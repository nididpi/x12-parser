...
public class X12Reader_udf2 {
    ...
    private static final String _X218_ANSI_VERSION = "005010X218";
    ...
    public enum FileType {
        ANSI820_5010_X218("mapping/820.5010.X218.xml"),
    ...
    static {
        _TYPES.put(FileType.ANSI820_5010_X218, _X218_ANSI_VERSION);
     ...
     */
    public X12Reader_udf2(FileType type, File file) throws IOException {
        this._type = type;
     ...
     * @throws IOException if there was an error reading the input file
     */
    public X12Reader_udf2(FileType type, File file, Charset charset) throws IOException {
        this._type = type;
     ...
     * @throws IOException if there was an error reading the input file
     */
    public X12Reader_udf2(FileType type, InputStream input) throws IOException {
        this._type = type;
     ...
     * @throws IOException if there was an error reading the input file
     */
    public X12Reader_udf2(FileType type, InputStream input, Charset charset) throws IOException {
        this._type = type;
     ...
     * @throws IOException if there was an error reading the input file
     */
    public X12Reader_udf2(FileType type, Reader reader) throws IOException {
        this._type = type;
